...
public class Product {
    ...
    public Product(int id, String title, String name, String details, String description, String readme,
                   int amount, float price, Blob image, ArrayList<Category> categories)
    {
        this.id = id;
        this.title = title;
        this.name = name;
    ...
    public Product(int id, String title, String description, int amount, float price, Blob image, ArrayList<Category> categories) {
        this.id = id;
        this.title = title;
        this.description = description;
        this.amount = amount;
